...
inline const std::array<std::array<Mode, NUM_AFS>, 112> afList{{
    ...
    /* PB0 */ {NA, TIM1_CH2N, TIM3_CH3, TIM8_CH2N, NA, NA, NA, SPI3_MOSI, UART4_CTS, NA, OTG_HS_ULPI_D1, NA, SDIO_D1, NA, NA, NA},
    /* PB1 */ {NA, TIM1_CH3N, TIM3_CH4, TIM8_CH3N, NA, NA, NA, NA, NA, NA, OTG_HS_ULPI_D2, NA, SDIO_D2, NA, NA, NA},
    /* PB2 */ {NA, TIM2_CH4, NA, NA, NA, NA, SAI1_SD_A, SPI3_MOSI, NA, QUADSPI_CLK, OTG_HS_ULPI_D4, NA, SDIO_CK, NA, NA, NA},
    /* PB3 */ {SWO, TIM2_CH2, NA, NA, I2C2_SDA, SPI1_SCK, SPI3_SCK, NA, NA, NA, NA, NA, NA, NA, NA, NA},
    /* PB4 */ {NJTRST, NA, TIM3_CH1, NA, I2C3_SDA, SPI1_MISO, SPI3_MISO, SPI2_NSS, NA, NA, NA, NA, NA, NA, NA, NA},
    /* PB5 */ {NA, NA, TIM3_CH2, NA, I2C1_SMBA, SPI1_MOSI, SPI3_MOSI, NA, NA, CAN2_RX, OTG_HS_ULPI_D7, NA, FMC_SDCKE1, DCMI_D10, NA, NA},
    /* PB6 */ {NA, NA, TIM4_CH1, HDMI_CEC, I2C1_SCL, NA, NA, USART1_TX, NA, CAN2_TX, QUADSPI_BK1_NCS, NA, FMC_SDNE1, DCMI_D5, NA, NA},
    /* PB7 */ {NA, NA, TIM4_CH2, NA, I2C1_SDA, NA, NA, USART1_RX, SPDIF_RX0, NA, NA, NA, FMC_NL, DCMI_VSYNC, NA, NA},
    /* PB8 */ {NA, TIM2_CH1, TIM4_CH3, TIM10_CH1, I2C1_SCL, NA, NA, NA, NA, CAN1_RX, NA, NA, SDIO_D4, DCMI_D6, NA, NA},
    /* PB9 */ {NA, TIM2_CH2, TIM4_CH4, TIM11_CH1, I2C1_SDA, SPI2_NSS, SAI1_FS_B, NA, NA, CAN1_TX, NA, NA, SDIO_D5, DCMI_D7, NA, NA},
    /* PB10 */ {NA, TIM2_CH3, NA, NA, I2C2_SCL, SPI2_SCK, SAI1_SCK_A, USART3_TX, NA, NA, OTG_HS_ULPI_D3, NA, NA, NA, NA, NA},
    /* PB11 */ {NA, TIM2_CH4, NA, NA, I2C2_SDA, NA, NA, USART3_RX, SAI2_SD_A, NA, NA, NA, NA, NA, NA, NA},
    /* PB12 */ {NA, TIM1_BKIN, NA, NA, I2C2_SMBA, SPI2_NSS, SAI1_SCK_B, USART3_CK, NA, CAN2_RX, OTG_HS_ULPI_D5, NA, OTG_HS_ID, NA, NA, NA},
    /* PB13 */ {NA, TIM1_CH1N, NA, NA, NA, SPI2_SCK, NA, USART3_CTS, NA, CAN2_TX, OTG_HS_ULPI_D6, NA, NA, NA, NA, NA},
    /* PB14 */ {NA, TIM1_CH2N, NA, TIM8_CH2N, NA, SPI2_MISO, NA, USART3_RTS, NA, TIM12_CH1, NA, NA, OTG_HS_DM, NA, NA, NA},
    /* PB15 */ {RTC_REFIN, TIM1_CH3N, NA, TIM8_CH3N, NA, SPI2_MOSI, NA, NA, NA, TIM12_CH2, NA, NA, OTG_HS_DP, NA, NA, NA},

    /* PC0 */ {NA, NA, NA, NA, NA, NA, SAI1_MCLK_B, NA, NA, NA, OTG_HS_ULPI_STP, NA, FMC_SDNWE, NA, NA, NA},
    /* PC1 */ {NA, NA, NA, NA, NA, SPI3_MOSI, SAI1_SD_A, SPI2_MOSI, NA, NA, NA, NA, NA, NA, NA, NA},
    /* PC2 */ {NA, NA, NA, NA, NA, SPI2_MISO, NA, NA, NA, NA, OTG_HS_ULPI_DIR, NA, FMC_SDNE0, NA, NA, NA},
    /* PC3 */ {NA, NA, NA, NA, NA, SPI2_MOSI, NA, NA, NA, NA, OTG_HS_ULPI_NXT, NA, FMC_SDCKE0, NA, NA, NA},
    /* PC4 */ {NA, NA, NA, NA, NA, I2S1_MCK, NA, NA, SPDIF_RX2, NA, NA, NA, FMC_SDNE0, NA, NA, NA},
    /* PC5 */ {NA, NA, NA, NA, NA, NA, NA, USART3_RX, SPDIF_RX3, NA, NA, NA, FMC_SDCKE0, NA, NA, NA},
    /* PC6 */ {NA, NA, TIM3_CH1, TIM8_CH1, FMPI2C1_SCL, I2S2_MCK, NA, NA, USART6_TX, NA, NA, NA, SDIO_D6, DCMI_D0, NA, NA},
    /* PC7 */ {NA, NA, TIM3_CH2, TIM8_CH2, FMPI2C1_SDA, SPI2_SCK, I2S3_MCK, SPDIF_RX1, USART6_RX, NA, NA, NA, SDIO_D7, DCMI_D1, NA, NA},
    /* PC8 */ {TRACE_D0, NA, TIM3_CH3, TIM8_CH3, NA, NA, NA, UART5_RTS, USART6_CK, NA, NA, NA, SDIO_D0, DCMI_D2, NA, NA},
    /* PC9 */ {MCO2, NA, TIM3_CH4, TIM8_CH4, I2C3_SDA, I2S_CKIN, NA, UART5_CTS, NA, QUADSPI_BK1_IO0, NA, NA, SDIO_D1, DCMI_D3, NA, NA},
    /* PC10 */ {NA, NA, NA, NA, NA, NA, SPI3_SCK, USART3_TX, UART4_TX, QUADSPI_BK1_IO1, NA, NA, SDIO_D2, DCMI_D8, NA, NA},
    /* PC11 */ {NA, NA, NA, NA, NA, NA, SPI3_MISO, USART3_RX, UART4_RX, QUADSPI_BK2_NCS, NA, NA, SDIO_D3, DCMI_D4, NA, NA},
    /* PC12 */ {NA, NA, NA, NA, I2C2_SDA, NA, SPI3_MOSI, USART3_CK, UART5_TX, NA, NA, NA, SDIO_CK, DCMI_D9, NA, NA},
    /* PC13 */ {NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA},
    /* PC14 */ {NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA},
    /* PC15 */ {NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA, NA},
    ...
    /* PD2 */ {NA, NA, TIM3_ETR, NA, NA, NA, NA, NA, UART5_RX, NA, NA, NA, SDIO_CMD, DCMI_D11, NA, NA},
    /* PD3 */ {TRACE_D1, NA, NA, NA, NA, SPI2_SCK, NA, USART2_CTS, NA, QUADSPI_CLK, NA, NA, FMC_CLK, DCMI_D5, NA, NA},
    ...
    /* PD6 */ {NA, NA, NA, NA, NA, SPI3_MOSI, SAI1_SD_A, USART2_RX, NA, NA, NA, NA, FMC_NWAIT, DCMI_D10, NA, NA},
    ...
    /* PD11 */ {NA, NA, NA, NA, FMPI2C1_SMBA, NA, NA, USART3_CTS, NA, QUADSPI_BK1_IO0, SAI2_SD_A, NA, FMC_A16, NA, NA, NA},
    ...
    /* PD14 */ {NA, NA, TIM4_CH3, NA, FMPI2C1_SCL, NA, NA, NA, SAI2_SCK_A, NA, NA, NA, FMC_D0, NA, NA, NA},
    ...
    /* PE4 */ {TRACE_D1, NA, NA, NA, NA, SPI4_NSS, SAI1_FS_A, NA, NA, NA, NA, NA, FMC_A20, DCMI_D4, NA, NA},
